...
# Summary statistics
sum_fitness = group_by(fitness, Genotype, Trait, Treatment) %>% 
  summarise(mu = median(Value))

saveRDS(sum_fitness, file = "Intermediate/Fitness/DataForPCA.rds")
saveRDS(fitness, file = "Intermediate/Fitness/DataForPCA_all.rds")
